...
* Spring MVC com.Test: A framework, also known as `MockMvc`, for testing annotated controllers
...
See <<testing.adoc#spring-mvc-test-framework, Spring MVC com.Test>> for more details.
