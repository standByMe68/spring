...
public class DeferredImportSelectorTests {
	...
	public void entryEqualsSameInstance() {
		...
		Group.Entry entry = new Group.Entry(metadata, "com.example.com.Test");
	...
	public void entryEqualsSameMetadataAndClassName() {
		AnnotationMetadata metadata = mock(AnnotationMetadata.class);
		assertEquals(new Group.Entry(metadata, "com.example.com.Test"),
				new Group.Entry(metadata, "com.example.com.Test"));
	}

	@Test
	public void entryEqualDifferentMetadataAndSameClassName() {
		assertNotEquals(
				new Group.Entry(mock(AnnotationMetadata.class), "com.example.com.Test"),
				new Group.Entry(mock(AnnotationMetadata.class), "com.example.com.Test"));
	}
	...
	public void entryEqualSameMetadataAnDifferentClassName() {
		AnnotationMetadata metadata = mock(AnnotationMetadata.class);
		assertNotEquals(new Group.Entry(metadata, "com.example.com.Test"),
